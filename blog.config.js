...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Welcome to my creepy insane corner💅🏻, 祝你早安午安晚安, Hi，我是王木木',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '王木木', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '很想死的小女孩', // 作者简介
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/iamlinfang_?igsh=OGQ5ZDc2ODk2ZA%3D%3D&utm_source=qr', // 您的instagram地址
